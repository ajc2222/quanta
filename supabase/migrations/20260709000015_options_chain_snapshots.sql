...
CREATE INDEX idx_options_snapshot_time ON options_chain_snapshots (underlying, snapshot_timestamp DESC);
...
CREATE INDEX idx_options_latest ON options_chain_snapshots (underlying, snapshot_timestamp DESC, strike);
