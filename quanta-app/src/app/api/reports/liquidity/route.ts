...
import { queryLiquidityStats } from '@/lib/reports/liquidity';

const REPORT_TYPE = 'liquidity';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await getOrCompute(cacheKey, () => queryLiquidityStats(query), { ttl: 7200 });
